function varargout = SolidWorks2019ExportWizard(varargin)            
...
% Last Modified by GUIDE v2.5 14-Feb-2021 17:17:43
...
%Added by Hongsun 2021-02-14
strctOutput.direct = fullfile(pwd,'Solidworks');
strctOutput.m_strGridFileName = fullfile(pwd,'Solidworks','Grid.SLDPRT');
strctOutput.m_strChamberFileName = fullfile(pwd,'Solidworks','Chamber.SLDPRT');
strctOutput.m_strCAPFileName = fullfile(pwd,'Solidworks','CAP.SLDPRT');
...
%Added by Hongsun 2021-02-14
set(handles.hOutputFolderEdit, 'String',strctOutput.direct);
...
% --- Executes on button press in hBrowseOutputFolder.
function hBrowseOutputFolder_Callback(hObject, eventdata, handles)
% hObject    handle to hBrowseOutputFolder (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
direct = uigetdir(pwd, 'Select Directory');
strctOutput = getappdata(handles.figure1,'strctOutput');

strctOutput.direct = direct;
strctOutput.m_strGridFileName = fullfile(direct,'Grid.SLDPRT');
strctOutput.m_strChamberFileName = fullfile(direct,'Chamber.SLDPRT');
strctOutput.m_strCAPFileName = fullfile(direct,'CAP.SLDPRT');
set(handles.hOutputFolderEdit, 'String', strctOutput.direct);
setappdata(handles.figure1,'strctOutput',strctOutput);
...
% --- Executes on button press in withRing.
function withRing_Callback(hObject, eventdata, handles)
% hObject    handle to withRing (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hint: get(hObject,'Value') returns toggle state of withRing



function gridRingDiameterEdit_Callback(hObject, eventdata, handles)
% hObject    handle to gridRingDiameterEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of gridRingDiameterEdit as text
%        str2double(get(hObject,'String')) returns contents of gridRingDiameterEdit as a double


% --- Executes during object creation, after setting all properties.
function gridRingDiameterEdit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to gridRingDiameterEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function gridRingHeightEdit_Callback(hObject, eventdata, handles)
% hObject    handle to gridRingHeightEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of gridRingHeightEdit as text
%        str2double(get(hObject,'String')) returns contents of gridRingHeightEdit as a double


% --- Executes during object creation, after setting all properties.
function gridRingHeightEdit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to gridRingHeightEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function chamberHeightEdit_Callback(hObject, eventdata, handles)
% hObject    handle to chamberHeightEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of chamberHeightEdit as text
%        str2double(get(hObject,'String')) returns contents of chamberHeightEdit as a double


% --- Executes during object creation, after setting all properties.
function chamberHeightEdit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to chamberHeightEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function chamberAngleEdit_Callback(hObject, eventdata, handles)
% hObject    handle to chamberAngleEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of chamberAngleEdit as text
%        str2double(get(hObject,'String')) returns contents of chamberAngleEdit as a double


% --- Executes during object creation, after setting all properties.
function chamberAngleEdit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to chamberAngleEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function hOutputFolderEdit_Callback(hObject, eventdata, handles)
% hObject    handle to hOutputFolderEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of hOutputFolderEdit as text
%        str2double(get(hObject,'String')) returns contents of hOutputFolderEdit as a double


% --- Executes during object creation, after setting all properties.
function hOutputFolderEdit_CreateFcn(hObject, eventdata, handles)
% hObject    handle to hOutputFolderEdit (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
