...
g_strctModule.m_astrctChambers(g_strctModule.m_iCurrChamber).m_astrctGrids(iSelectedGrid) = [];
iNumRemainingGrids = length(g_strctModule.m_astrctChambers(g_strctModule.m_iCurrChamber).m_astrctGrids);
g_strctModule.m_astrctChambers(g_strctModule.m_iCurrChamber).m_iGridSelected = iNumRemainingGrids;
