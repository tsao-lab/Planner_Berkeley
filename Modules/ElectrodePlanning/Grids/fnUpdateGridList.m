...
if g_strctModule.m_iCurrChamber > length(g_strctModule.m_astrctChambers)
...
if iNumGrids == 0
    ...
    strGrids = '';
    for k=1:iNumGrids
        strctGrid = g_strctModule.m_astrctChambers(g_strctModule.m_iCurrChamber).m_astrctGrids(k);
