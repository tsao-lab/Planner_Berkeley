...
if isfield(g_strctModule.m_strctPanel,'m_hMainVolSurface') && ...
        ~isempty(g_strctModule.m_strctPanel.m_hMainVolSurface) && ...
        ishandle(g_strctModule.m_strctPanel.m_hMainVolSurface)
...
if ~isempty(strctIsoCRS)
    ...
    if iNumVertices > 0
        ...
        set(g_strctModule.m_strctPanel.m_hMainVolSurface,'FaceColor',...
            ...
            'EdgeColor','none','facealpha',g_strctModule.m_acAnatVol{ ...
            g_strctModule.m_iCurrAnatVol}.m_strctIsoSurfParam.m_fSurfaceOpacity);
