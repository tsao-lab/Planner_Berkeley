...
afDV = g_strctModule.m_a2fAtlasReg(1:3,3));
afAP = g_strctModule.m_a2fAtlasReg(1:3,1));
afML = g_strctModule.m_a2fAtlasReg(1:3,2));

pt3fZeroPosMM = g_strctModule.m_a2fAtlasReg(1:3,4);
