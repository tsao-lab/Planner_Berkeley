function strctModel = fnBuildChronicChamberModel(fOuterDiameterMM, ...
    fInnerDiameterMM, fChamberH1, fChamberAngle)
...
strctModel.m_astrctMeshShort = fnBuildShortModel(fnGetStandardCristChamberParams(...
    fOuterDiameterMM, fInnerDiameterMM, fChamberH1, fChamberAngle));
strctModel.m_astrctMeshLong = fnBuildLongModel(fnGetStandardCristChamberParams(...
    fOuterDiameterMM, fInnerDiameterMM, fChamberH1, fChamberAngle));
return;


function strctParams = fnGetStandardCristChamberParams(...
    fOuterDiameterMM, fInnerDiameterMM, fChamberH1, fChamberAngle)
...
%     fChamberH2 = 33;
% end
fChamberH2 = fChamberH1+fOuterDiameterMM*tan(fChamberAngle);
strctParams.m_strManufacterer = 'Chronic';
strctParams.m_strName = sprintf('Chronic %.1fmm %d deg', fOuterDiameterMM, fChamberAngle);
