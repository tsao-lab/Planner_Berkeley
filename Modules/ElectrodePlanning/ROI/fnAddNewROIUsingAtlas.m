...
Tmp = a2fCRS_To_XYZ \ g_strctModule.m_acAnatVol{g_strctModule.m_iCurrAnatVol}.m_a2fAtlasReg * ...
    g_strctApp.m_strctAtlasNew.m_strctMRI.vox2ras0 * [aiJ-1, aiI-1, aiK-1, ones(size(aiI))]';
g_strctModule.m_acAnatVol{g_strctModule.m_iCurrAnatVol}.m_astrctROIs(iSelectedROI).m_aiVolumeIndices = ...
    sub2ind(size(g_strctModule.m_acAnatVol{g_strctModule.m_iCurrAnatVol}.m_a3fVol), ...
    round(Tmp(2,:))+1, round(Tmp(1,:))+1, round(Tmp(3,:))+1);
g_strctModule.m_acAnatVol{g_strctModule.m_iCurrAnatVol}.m_astrctROIs(iSelectedROI).m_strName = ...
