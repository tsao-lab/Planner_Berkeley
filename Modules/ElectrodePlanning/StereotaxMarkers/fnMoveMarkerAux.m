...
g_strctModule.m_astrctMarkers(iCurrMarker).m_strctCrossSectionXY = ...
    g_strctModule.m_strctCrossSectionXY;

g_strctModule.m_astrctMarkers(iCurrMarker).m_strctCrossSectionYZ = ...
    g_strctModule.m_strctCrossSectionYZ;

g_strctModule.m_astrctMarkers(iCurrMarker).m_strctCrossSectionXZ = ...
...
pt3fPosMM = a2fCRS_To_XYZ*[g_strctModule.m_astrctMarkers(iCurrMarker).m_pt3fPosition_vox(:);1];
...
g_strctModule.m_astrctMarkers(iCurrMarker).m_pt3fPosition_vox = pt3fNewPosVox(1:3);
