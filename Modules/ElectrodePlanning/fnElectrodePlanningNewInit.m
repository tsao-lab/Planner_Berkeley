...
if g_strctApp.m_bAtlasLoaded
    ...
    c = zeros(max(strctAtlasNew.m_strctMRI.vol, [], 'all')+1, 3);
    idc = g_strctApp.m_tableRegions.label+1;
    c(idc, :) = g_strctApp.m_tableRegions.color;
    colormap(strctPanel.m_strctXY.m_hAxes, c);
    colormap(strctPanel.m_strctYZ.m_hAxes, c);
    colormap(strctPanel.m_strctXZ.m_hAxes, c);
end
